...
function NoMessage(props) {
    ...
    //     if ( e.target != document.getElementById("box-new-user-box")) {
    //         boxNewUserBoxC.style.display = "none";
    //     }
    // }
    // );

    var boxNewUserBoxC = document.getElementById("box-new-user-box-c")
    function show_box() {
        boxNewUserBoxC.style.zIndex = "999";
        boxNewUserBoxC.style.display = "block";
    }
    ...
    return (
        ...
        <>
            ...
            <div id='box-new-user-box-c'>
                <div className="box-search back-col-wh " id="box-new-user-box">
                    <div className="top-search d-flex ali-center">
