...
// import { render } from 'react-dom'; class= write Post
...
class Header extends Component {
    ...
    render() {
        ...
        let show_menu = (eff_name = 'effect-left-side', menu_name = 'aside-left2') => {
            console.log("show menu func is clicked ...");
            if (document.getElementById(eff_name).style.opacity == 0) {
                document.getElementById(eff_name).style.transitionDelay = "0s";
                document.getElementById(eff_name).style.zIndex = 10;
                document.getElementById(eff_name).style.transitionDelay = "0s";
                document.getElementById(eff_name).style.opacity = 1;
                document.getElementById(menu_name).style.transitionDelay = "0s";
                document.getElementById(menu_name).style.left = "0";
            }
            else {
                document.getElementById(menu_name).style.transitionDelay = "0s";
                document.getElementById(menu_name).style.transitionDuration = ".6s";
                document.getElementById(menu_name).style.left = "-1000px";
                document.getElementById(eff_name).style.opacity = 0;
                document.getElementById(eff_name).style.transitionDelay = ".2s";
                document.getElementById(eff_name).style.zIndex = -3;
            }
        }
        return (
            <header className="header d-flex ali-center pad-top-2rem pad-bot-2rem bor-bot back-col-wh">
                ...
                <div className="father-logo flex-center">
                    <div className="logo flex-center">
                        <div className="menu-side-ic menu-side-ic1 bo-rad" onClick={() => { show_menu('effect-left-side', 'aside-left2') }}>
                ...
                <nav className="d-flex ali-center">
                    ...
                    {/* <div className="inp-post inp-post1">
                        <NavLink className={({ isActive }) => isActive ? activeLink : normalLink} to="/posting">
                            <input type="text" placeholder="Write Post...." readOnly className="trans cur-po" />
                        </NavLink>
                    </div> */}
