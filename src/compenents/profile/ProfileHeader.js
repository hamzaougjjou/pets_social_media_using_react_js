...
import { ProfileHeaderLoading } from '../loading/Index';
...
function ProfileHeader() {
    ...
    const showChangeProfilePopUp = () => {
        setShowPopUp(true);
    }
    const hideChangeProfilePopUp = () => {
        setShowPopUp(!true);
    }
    ...
    return (
        <>
            {
                showPopUp ?
                    <ChangeProfile setShowPopUp={setShowPopUp} />
                    :
                    null
            }
                    ...
                    !loading ?
                        <div className="top-profile d-flex gap-20px">
                            ...
                            <div className="img-prof-media" >
                                <div onClick={showChangeProfilePopUp} className="image-profile image-profile-1 bo-rad po-rel" style={{ backgroundImage: `url('${profile_img}') ` }}>
                            ...
                            <div className="all-info-prof">
                                <div className="infor-profile flex-between">
                                    <div className="inf-prof-addr">
                                        <div className="my-name d-flex ali-center gap-5px">{user.name}
                                        ...
                                        <div className="address-prof d-flex gap-5px">
                                            ...
                                            <span className="d-flex ali-center">
                                                ...
                                                {user.address == null ? "Adress not exist" : user.address}
                                            </span>
                                            <span className="d-flex ali-center">
                                                <span className="svg-icon svg-icon-4 me-1">
                                                    <svg width="17" height="17" viewBox="0 0 24 24" fill="none"
                                ...
                                <div className="follow-info flex-between">
                                    <div className="number d-flex gap-20px">
                                        <div className="Friends-num bo-rad flex-center">
                                            <span className="d-block"> {user.friends_count} </span>
                                            <span>Friends</span>
                                        </div>
