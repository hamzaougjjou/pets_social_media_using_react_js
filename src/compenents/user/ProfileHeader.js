...
// Hamza ougjjou img
function ProfileHeader( {loading , user }) {
    ...
    if (!loading)
        profile_img = user.profile_img === null ? profile : storageUrl + "/" + user.profile_img;
                    ...
                    !loading ?
                        <div className="top-profile d-flex gap-20px">
                            ...
                            <div className="img-prof-media" >
                                <div className="image-profile image-profile-1 bo-rad po-rel" style={{ backgroundImage: `url('${profile_img}') ` }}>
